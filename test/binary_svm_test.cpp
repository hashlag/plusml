...
TEST(BinarySVMTests, LinearlySeparableTest) {
  plusml::BinarySVM model(2);
  ...
  model.FitSGD(testcase.first, testcase.second, 0.01, 0.01, 10, 150);
...
TEST(BinarySVMTests, NotLinearlySeparableTest) {
  plusml::BinarySVM model(2);
